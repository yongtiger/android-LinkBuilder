...
public class LinkBuilder {
    ...
    public static LinkBuilder on(@NonNull TextView tv) {
    ...
    public LinkBuilder setTextView(@NonNull TextView textView) {
        this.textView = textView;
     ...
     */
    private void applyLink(@NonNull Link link, @NonNull Range range, @NonNull Spannable text) {
     ...
     */
    private void addLinksFromPattern(@NonNull Link linkWithPattern) {
